...
// =================================================================
// 🎯 1. GenderSelect Component: ใช้ปุ่มแสดงรูปภาพสำหรับเลือกเพศ
// =================================================================
const GenderSelect = ({ value, onChange }) => {
    // ข้อมูลเพศพร้อม Path รูปภาพและสไตล์
    const genders = [
        { 
            value: "Male", 
            label: "Male", 
            ...
            {genders.map((g) => (
                <button
                    ...
                    className={`flex items-center justify-center gap-2 p-3 flex-1 rounded-xl 
                        ...
                        ${g.style}
                        ${value === g.value 
                            ? 'ring-2 ring-offset-2 ring-pink-500' // สไตล์เมื่อถูกเลือก
                            : 'bg-white/80 border-gray-200 text-gray-700' // สไตล์ปกติ
                        }
                    `}
                >
                    {/* 💡 แสดงรูปภาพ Gender */}
...
  // ----------------------------
  // 📌 Load all pet slots (1–4) (unchanged)
  // ----------------------------
...
  // ----------------------------
  // 📌 Load specific pet slot (unchanged)
  // ----------------------------
