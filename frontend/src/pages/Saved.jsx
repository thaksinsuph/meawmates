...
    try {
      // ⭐ หากการเรียก API สำเร็จ ควรมี likes, comments, savedCount กลับมา
...
                  
                    {/* ⭐ START: แสดงจำนวน Like, Comment, Saved */}
...
                  </div>
                    ...
                    {/* 2. Comment Count */}
                    {/* ต้องแน่ใจว่า p.comments มีข้อมูล */}
                    ...
                    {/* 3. Saved Count */}
                    {/* Saved Count ควรจะอยู่ในข้อมูลที่ Backend ส่งมาเป็น p.savedCount */}
                    <div className="flex items-center gap-1 text-gray-500">
                        <img src="/images/Savedd.png" className="w-5 h-5 opacity-70" />
                        <span>{p.savedCount || 0}</span>
                    </div>

                    {/* ⭐ END: แสดงจำนวน Like, Comment, Saved */}
                  
